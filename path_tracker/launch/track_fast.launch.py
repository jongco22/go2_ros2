...
def generate_launch_description():
    ...
    declare_pose_increment_arg = DeclareLaunchArgument(
        'pose_increment',
        default_value='5',
        description='Pose increment to move to next pose'
    )
    ...
    path_publisher_node = Node(
        ...
        parameters=[{
            ...
            'pose_increment': LaunchConfiguration('pose_increment'),
        }],
    )
