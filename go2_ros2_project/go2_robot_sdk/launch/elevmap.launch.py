...
class Go2LaunchConfig:
    ...
    def _get_config_paths(self) -> dict:
        ...
        return {
            ...
            'nav2': os.path.join(self.package_dir, 'config', 'nav2_elev_params.yaml'),
...
class Go2NodeFactory:
    ...
    def create_launch_arguments(self) -> List[DeclareLaunchArgument]:
        ...
        return [
            ...
            DeclareLaunchArgument('use_tf_clock', default_value='false', description='Publish /clock from /tf'),
            DeclareLaunchArgument('use_sim_time', default_value='True', description='Use simulation time'),
        ]

    def create_driver_nodes(self) -> List[Node]:
        """Create Go2 sport client node."""
    ...
    def odom_tf_publisher_nodes(self) -> List[Node]:
        ...
        return [
            ...
            Node(
                package='go2_robot_sdk',
                executable='initialpose_map_odom_tf',
                name='initialpose_map_odom_tf',
                output='screen',
                parameters=[{
    ...
    #     """Create core Go2 robot nodes"""
        use_tf_clock = LaunchConfiguration('use_tf_clock', default='true')
        return [
            Node(
                package='go2_robot_sdk',
                executable='tf_clock_publisher',
                name='tf_clock_publisher',
                output='screen',
                condition=IfCondition(use_tf_clock),
            ),
            Node(
    ...
    def create_include_launches(self) -> List[IncludeLaunchDescription]:
        ...
        return [
            ...
            Node(
                ...
                parameters=[{
                    'use_sim_time': use_sim_time,
                    'yaml_filename': '/root/ros2_ws/maps/slope_costmap.yaml',
                }],
                remappings=[
                    ('map', 'slope_map'),
                ],
